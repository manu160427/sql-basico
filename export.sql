...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."AFICION" 
   (	"NONBRE_AFICION" VARCHAR2(100 BYTE), 
	"AFICION_ID" NUMBER, 
	"EQUIPO_ID" NUMBER
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."AFICION"."NONBRE_AFICION" IS 'nombre de la aficion ';
   COMMENT ON COLUMN "HR"."AFICION"."AFICION_ID" IS 'Clave primaria';
--------------------------------------------------------
--  DDL for Table CANTICOS
--------------------------------------------------------

  CREATE TABLE "HR"."CANTICOS" 
   (	"TIPOS" VARCHAR2(100 BYTE), 
	"CANTICOS_ID" NUMBER, 
	"AFICION_ID" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."EQUIP"."NOMBRE" IS 'el nombre del equipo';
   COMMENT ON COLUMN "HR"."EQUIP"."FECHA_DE_FUNDACION" IS 'fecha de fundacion';
   COMMENT ON COLUMN "HR"."EQUIP"."AFICION_ID" IS 'clave ajena de aficion';
   COMMENT ON COLUMN "HR"."EQUIP"."EQUIPO_ID" IS 'id';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."JUGADORES"."JUGADORES_ID" IS 'CLAVE PRIMARIA';
   COMMENT ON COLUMN "HR"."JUGADORES"."EQUIPO_ID" IS 'CLave ajena';
   COMMENT ON COLUMN "HR"."JUGADORES"."NOMBRE_JU" IS 'Nmobre de los Jugadores';
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into HR.AFICION (NONBRE_AFICION,AFICION_ID,EQUIPO_ID) values ('la decima','1',null);
Insert into HR.AFICION (NONBRE_AFICION,AFICION_ID,EQUIPO_ID) values ('ultra sur','2',null);
REM INSERTING into HR.CANTICOS
SET DEFINE OFF;
Insert into HR.CANTICOS (TIPOS,CANTICOS_ID,AFICION_ID) values ('real madrid aleee!! real madrid ale!!!','1',null);
Insert into HR.CANTICOS (TIPOS,CANTICOS_ID,AFICION_ID) values ('illa illa illa juanito maravilla!!','2',null);
...
REM INSERTING into HR.EQUIP
SET DEFINE OFF;
Insert into HR.EQUIP (NOMBRE,FECHA_DE_FUNDACION,AFICION_ID,EQUIPO_ID,ESTADIO_ID) values ('real madrid',null,null,'1',null);
...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,EQUIPO_ID,NOMBRE_JU,NACIONALIDAD) values ('1','1','pepe','portugues');
Insert into HR.JUGADORES (JUGADORES_ID,EQUIPO_ID,NOMBRE_JU,NACIONALIDAD) values ('2','1','sergio ramos','español');
Insert into HR.JUGADORES (JUGADORES_ID,EQUIPO_ID,NOMBRE_JU,NACIONALIDAD) values ('3','1','cristiano','portugues');
...
--------------------------------------------------------
--  DDL for Index EQUIP_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."EQUIP_PK" ON "HR"."EQUIP" ("EQUIPO_ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" MODIFY ("NONBRE_AFICION" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."CANTICOS" MODIFY ("TIPOS" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."JUGADORES" MODIFY ("NACIONALIDAD" NOT NULL ENABLE);
  ALTER TABLE "HR"."JUGADORES" MODIFY ("NOMBRE_JU" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."ESTADIO" MODIFY ("SECTOR" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIP" ADD CONSTRAINT "EQUIP_PK" PRIMARY KEY ("EQUIPO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."EQUIP" MODIFY ("EQUIPO_ID" NOT NULL ENABLE);
  ALTER TABLE "HR"."EQUIP" MODIFY ("NOMBRE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."COUNTRIES" MODIFY ("COUNTRY_NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" ADD CONSTRAINT "EQUIPO_FK1" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIP" ("EQUIPO_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EMPLOYEES" ADD CONSTRAINT "EMP_MANAGER_FK" FOREIGN KEY ("MANAGER_ID")
	  REFERENCES "HR"."EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EQUIP
--------------------------------------------------------

  ALTER TABLE "HR"."EQUIP" ADD CONSTRAINT "ESTADIO_FK" FOREIGN KEY ("ESTADIO_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPO_FK" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIP" ("EQUIPO_ID") ENABLE;
--------------------------------------------------------
